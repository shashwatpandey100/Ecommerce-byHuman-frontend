      ...
      <div className="pb-20 md:pb-24">
        <div className="w-full flex flex-col items-center pt-16 md:pt-16">
          ...
          <ul className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-12 px-2.5 md:px-12">
            <div
              style={{
                backgroundImage:
                  "linear-gradient(to top, rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.05)), url(https://imageseu.urbndata.com/is/image/UrbanOutfittersEU/0251422730225_011_b?$xlarge$&fit=constrain&fmt=webp&qlt=80&wid=1080)",
              }}
        ...
        <ul className="flex flex-col py-24">
          <div className="flex md:flex-row flex-col">
            ...
            <div className="w-full h-max md:h-[80vh] bg-[#fff8f0] flex flex-col items-center justify-center">
              <div className="px-8 py-16 md:p-16 w-full">
                <p className="text-[#111] font-mono">
                  Pack it. Strap it. Make it yours.
                </p>
                <h3 className="my-6 md:mt-0 font-times text-[3rem] md:text-[4.5rem] leading-[3.5rem] md:leading-[5rem]">
                  Mini, meet crossbody
                </h3>
                <p className="text-[#111] font-mono">
                ...
                <p className="mt-8 md:mt-5 text-[#000] font-[500] text-[12px] uppercase flex gap-3 items-center group">
                  Shop now{" "}
        ...
        <div className="flex flex-col gap-4 px-4 sm:px-4">
