...
const Hero: React.FC = () => {
  ...
  React.useEffect(() => {
    // Show the newsletter popup when the page loads
    const timeout = setTimeout(() => setShowNewsletter(true), 500) // Delay for user experience
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          ...
          <button
            ...
            >
              ...
              <button
                type="submit"
                className="w-full mt-3 bg-white  py-3 rounded-full border border-gray-700 font-semibold tracking-[0.04rem] text-sm transition"
              >
                SUBSCRIBE NOW
              </button>
            </form>
